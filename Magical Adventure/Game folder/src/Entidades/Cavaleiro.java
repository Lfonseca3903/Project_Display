...
/**
 *  Classe responsável pelo design de heróis do tipo cavaleiro
 */
public class Cavaleiro extends Heroi{

    /**
     * Método construtor do herói do tipo cavaleiro
     ...
     */
    public Cavaleiro(String nome, int maxHP, int forca, int nivel, int ouro, ArmaPrincipal armaPrincipal) {
        super(nome, maxHP, forca, nivel, ouro, armaPrincipal);
    }

    /**
     * Método de ataque adaptado às particularidades do cavaleiro
