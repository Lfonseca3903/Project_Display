...
/**
 *  Classe responsável pelo design de heróis do tipo arqueiro
 */
public class Arqueiro extends Heroi{

    /**
     * Método construtor do herói do tipo arqueiro
     ...
     */
    public Arqueiro(String nome, int maxHP, int forca, int nivel, int ouro, ArmaPrincipal armaPrincipal) {
        super(nome, maxHP, forca, nivel, ouro, armaPrincipal);
    }

    /**
     * Método de ataque adaptado às particularidades do arqueiro
